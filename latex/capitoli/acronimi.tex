...
\acro{SARIMAX}{Seasonal AutoRegressive Integrated Moving Average with eXogenous regressors}
\acro{ACF}{funzione di autocorrelazione}
\acro{PACF}{funzione di autocorrelazione parziale}
\acro{RMSE}{radice dell'errore quadratico medio}
\acro{MAE}{errore assoluto medio}
\acro{AIC}{criterio d'informazione di Akaike}
\end{acronym}