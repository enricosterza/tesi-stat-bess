...
La capacit\`a aggregata varia su una griglia da poche decine di megawatt ad alcuni gigawatt.
La scelta degli estremi merita una nota, perch\'e la prima versione era sbagliata: partendo
dal volume complessivo del mercato — in zona NORD si scambiano fra 15 e 25~GW per asta — si
era fissata una griglia che iniziava a 250~MW, ritenendo marginale tutto ci\`o che stava
sotto. La prima simulazione ha smentito il ragionamento, perch\'e gi\`a a 250~MW l'erosione
risultava di alcuni punti percentuali e la soglia cadeva fuori griglia.

La ragione \`e che ci\`o che determina l'effetto sul prezzo non \`e il volume complessivo
scambiato ma la \textbf{pendenza della curva attorno all'equilibrio}, dove i gradini sono
pochi e larghi. Un accumulo di taglia piccola rispetto al mercato pu\`o quindi essere grande
