...
% =====================================================================
%  FRONTESPIZIO (segnaposto: sostituire i campi fra parentesi quadre)
% =====================================================================
\begin{titlepage}
\centering
...
\vspace{0.3cm}
{\large Corso di Laurea Magistrale in [Corso di laurea]\par}
...
\begin{flushleft}
\begin{tabular}{@{}ll@{}}
\textbf{Relatore:}    & Prof. [Nome Cognome] \\[0.3cm]
